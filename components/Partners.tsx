          ...
          <div className="space-y-10">
            <div>
              ...
              <p className="text-gray-500 text-xl leading-relaxed font-medium">
                我們正在尋找 HR 專家、NGO 領袖與品牌夥伴，透過「回聲機制」重新定義組織、社區與商業的連結。
              </p>
            </div>
            <div className="space-y-8">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-xl font-black text-gray-900 mb-2">品牌廠商</h4>
                  <p className="text-gray-600 leading-relaxed">提供商品作為回聲點數兌換，將行銷預算轉化為實質的社會公益支持與品牌認同。</p>
                </div>
              </div>
            </div>
          </div>
              ...
              {status !== 'success' ? (
                <>
                  ...
                  <form className="space-y-6 flex-grow" onSubmit={handleSubmit}>
                    ...
                    {status === 'error' && <p className="text-red-500 text-xs font-bold text-center">傳送失敗，請稍後再試。</p>}
                  </form>
                </>
              ) : (
                <div className="flex-grow flex flex-col items-center justify-center text-center space-y-6 animate-fade-in">
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-gray-900 mb-2">提案已提交</h3>
                    <p className="text-gray-500 font-medium">感謝您的主動聯絡，我們會盡快查閱並與您連繫。</p>
                  </div>
                  <button onClick={() => setStatus('idle')} className="text-purple-600 font-black text-sm hover:underline">發送新提案</button>
                </div>
              )}
            </div>
          </div>
